...
![Close pivot calls](imgs/01a-calls.png)

I've added functionality to fetch the pivot-calls for the day, programmatically.

![Protocol tests](imgs/01b-tests.png)
![Code coverage](imgs/01c-coverage.png)
...
![Protocol distributions to investors](imgs/02-dists.png)
