...
![Protocol TVL](imgs/01b-tvl.png)

# PIVOTS

![`dusk` report](imgs/02a-dusk.png)

`dusk` has a call for a close USDC-on-HBAR pivot.

![Stader HBARX ratio](imgs/02b-stader.png)
![Close USDC-on-HBAR(x) pivot](imgs/02c-close-usdc-on-hbar-pivot.png)
