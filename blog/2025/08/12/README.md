...
![Close UNDEAD-on-ETH pivot](imgs/14a-close-undead-on-eth-pivot.png)

I close 1 UNDEAD-on-ETH pivot for gains of:

* actual ROI: 170.12% / 6899.16% APR projected
* or: 52.5k $UNDEAD -> $ETH -> 141.8k $UNDEAD HOLY!! 🎉🎉🎉
* or: $810-gained on $1,024 pivoted

I must be a magician because what is this wizardry?

![Swap 80% of gains to stable](imgs/14b-swap-gains-to-stable.png)
![Distribute gains](imgs/14c-dist-gains.png)
...
![Close UNDEAD-on-AVAX pivot](imgs/17a-close-undead-on-avax-pivot.png) 

I close 1 UNDEAD-on-AVAX pivot for gains of: 


* actual ROI: 126.79% / 7712.98% APR projected 
* or: 51000 $UNDEAD -> $AVAX -> 115662 $UNDEAD 
* or: $605.95 gain on a pivot of $989.71 

![Swap gains to stable](imgs/17b-swap-gains-to-stable.png) 
![Distribute gains to stakers](imgs/17c-dist-gains.png) 
...
![UNDEAD Ratio](imgs/21a-ratio.png) 
![Positive δ](imgs/21b-delta.png) 

The positive δ calls to open an UNDEAD-on-USDC pivot, which I do. 

![Open UNDEAD pivot](imgs/21c-open-undead-pivot.png) 

I also open an USDC-on-UNDEAD hedge. 

![Open USDC hedge](imgs/21d-open-usdc-hedge.png) 

* We are in the red for the $USDC-asset, so I must watch that for future pivots. 



The UNDEAD+USDC pivot pool composition and γ-apportionment are as charted. 

![The UNDEAD+USDC pivot pool composition](imgs/22a-comp.png) 
![The UNDEAD+USDC pivot pool γ-apportionment](imgs/22b-apport.png) 
# CONCLUSION, 2025-08-12 

This concludes pivot-activity for today. 

![Pivot Protocol dashboard](imgs/23a-dash.png) 
![Pivot Protocol TVL](imgs/23b-tvl.png) 
![Pivot Protocol pivot pools](imgs/23c-pools.png) 
![Pivot Distributions](imgs/23d-dists.png) 

* gains distributed to stakers or reinvested, total: $12,926.79 
* protocol NAV: $378,114.66 
* protocol 24-hour volume: $42,147.84 
