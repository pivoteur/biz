...
![Pivot Asset Allocations](imgs/silver/01-pivot-pools.png)
...
![BTC+ETH pivot pool: the OG](imgs/silver/02a-btc-eth-og.png)

* BTC+ETH pivot pool: grow blue chips but low volatility (so can appear 'slow')

![BTC+stable pivot pool](imgs/silver/02b-stable.png)
